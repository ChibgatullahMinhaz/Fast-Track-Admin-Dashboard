...
const dummyUsers: User[] = [
    { id: 1, name: "John Doe", email: "john@example.com", phone: "+8801712345678", role: "driver", status: "Active", dateJoined: "2023-08-01" },
    { id: 2, name: "Jane Smith", email: "jane@example.com", phone: "+8801712345679", role: "driver", status: "Inactive", dateJoined: "2023-07-15" },
    { id: 3, name: "Bob Johnson", email: "bob@example.com", phone: "+8801712345680", role: "driver", status: "Active", dateJoined: "2023-06-20" },
];
